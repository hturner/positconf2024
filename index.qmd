...
R Contributor Events<br> [![](dev_day1.jpg){width="40%"} ![](dev_day2.jpg){width="40%"}](https://contributor.r-project.org/events/)
:::
:::
:::
...
-   Other
    -   Employee time for contribution
